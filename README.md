# Challenge Data Analytics con Python implementacion con Airflow y Docker
...
1. - Una vez corriendo el container de la aplicacion, ir a http://localhost:8080/ 
2. - en Admin -> Variables, subir el archivo variables.json que se encuentra en el root del proyecto
